...
# Note: Gender input may need to be preprocessed as a numeric value if model requires it
gender_numeric = {"Male": 0, "Female": 1, "Other": 2}.get(gender, 0)  # Example encoding
input_data = [
